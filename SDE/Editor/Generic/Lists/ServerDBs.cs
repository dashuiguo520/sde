...
namespace SDE.Editor.Generic.Lists {
	public sealed class ServerDbs {
		...
		public static readonly ServerDbs CQuests = new ServerDbs("questid2display") { DisplayName = "客户端任务 [lub]", IsClientSide = true, ClientSidePath = () => ProjectConfiguration.ClientQuest };
		public static readonly ServerDbs CCheevo = new ServerDbs("achievement_list") { DisplayName = "客户端成就 [lub]", IsClientSide = true, ClientSidePath = () => ProjectConfiguration.ClientCheevo };
        ...
        public static readonly ServerDbs Combos2 = new ServerDbs("item_combo_db2")
        {
            DisplayName = "物品套装 [yml]",
            AlternativeName = "import\\item_combos",
            IsImport = true,
            SupportedFileType = FileType.Txt | FileType.Yaml  // 添加这一行
        };

        public static readonly ServerDbs Combos = new ServerDbs("item_combo_db")
        {
            DisplayName = "物品套装 [yml]",
            AdditionalTable = Combos2,
            SupportedFileType = FileType.Txt | FileType.Yaml  // 添加这一行
        };
